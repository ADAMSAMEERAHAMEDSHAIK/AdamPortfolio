    ...
    <footer className="bg-navy text-white py-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
          {/* Branding */}
          <div>
            <h3 className="text-xl font-bold mb-2 text-white">Adam Sameer Ahamed Shaik</h3>
            <p className="text-gray-300 text-sm">
              Showcasing my journey, skills, and innovations through projects and contributions.
            </p>
            <div className="flex space-x-4 mt-3">
              <a href="https://github.com/ADAMSAMEERAHAMEDSHAIK" target="_blank" rel="noopener noreferrer" className="text-white hover:text-gold transition-colors">
                <Github size={18} />
              </a>
              <a href="https://www.linkedin.com/in/asashaik/" target="_blank" rel="noopener noreferrer" className="text-white hover:text-gold transition-colors">
                <Linkedin size={18} />
              </a>
              <a href="mailto:adamsameerahamedshaik@gmail.com" className="text-white hover:text-gold transition-colors">
                <Mail size={18} />
              </a>
              <a href="tel:+918978725155" className="text-white hover:text-gold transition-colors">
                <Phone size={18} />
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <address className="not-italic text-gray-300 text-sm space-y-1">
              <p>Adam Sameer Ahamed Shaik</p>
              <p>Vijayawada</p>
              <p>
                <a href="mailto:adamsameerahamedshaik@gmail.com" className="hover:text-gold">adamsameerahamedshaik@gmail.com</a>
              </p>
              <p>
                <a href="tel:+918978725155" className="hover:text-gold">+91 8978725155</a>
              </p>
            </address>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-3 pt-2 text-center text-sm text-gray-400">
          <p>&copy; {new Date().getFullYear()} Adam Sameer Ahamed Shaik. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
