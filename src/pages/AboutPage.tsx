              ...
              <div className="prose max-w-none">
                ...
                <div className="mb-6 border border-gray-200 rounded-lg p-4">
                  ...
                  <p className="text-gray-700 mt-2">
                    Currently pursuing my B.Tech in CSE with a CGPA of 7.97. My coursework has deepened my understanding in core areas like programming, software design, and system architecture.
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  <div className="text-blue-700 font-bold text-lg mb-1">2019 – 2021</div>
                  <div className="text-lg font-semibold">Intermediate (MPC Stream)</div>
                  <div className="text-sm text-gray-600 mb-2">Narayana Junior College, Vijayawada</div>
                  <p className="text-gray-700 mt-2">
                ...
                <div className="flex space-x-4 mt-6">
                  ...
                  <a href="https://www.linkedin.com/in/asashaik/" className="btn-accent inline-flex items-center" target="_blank" rel="noopener noreferrer">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                  {[
                    ...
                    { title: 'Database Management (MySQL/OracleSQL)'},
